...
function RTCPeerConnection(configuration) {
  ...
  var localRtpParameters = [];
  var remoteRtpParameters = [];
...
RTCPeerConnection.prototype._sendRtp = function _sendRtp(rtpParameters) {
  rtpParameters.forEach(function(rtpParameters) {
...
RTCPeerConnection.prototype._receiveRtp = function _receiveRtp(rtpParameters) {
  rtpParameters.forEach(function(rtpParameters) {
    var type = rtpParameters.type;
...
RTCPeerConnection.prototype._startDtlsTransport =
  function _startDtlsTransport(dtlsParameters)
{
  this._dtlsTransport.start(dtlsParameters);
  return this;
};

RTCPeerConnection.prototype._startIceTransport =
  function _startIceTransport(iceParameters)
{
...
RTCPeerConnection.prototype._parseLocalDescription =
  function _parseLocalDescription(description)
{
