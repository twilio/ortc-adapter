...
RTCPeerConnection.prototype._ondtlsstatechange = function ondtlsstatechange(event) {
  void event;
...
RTCPeerConnection.prototype.createAnswer = function createAnswer(onSuccess, onFailure, options) {
